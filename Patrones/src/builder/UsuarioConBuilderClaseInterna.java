...
public class UsuarioConBuilderClaseInterna {
	...
	public static class Builder {
		...
		public UsuarioConBuilderClaseInterna build() {
			return new UsuarioConBuilderClaseInterna(this);
		}
	}

	UsuarioConBuilderClaseInterna(Builder builder) {
